            ...
            <div class="contenedor-medio text-center text-md-center">
              <div id="logo-footer" class="mx-auto">
                <a class="navbar-brand" href="#">
                  <img class="img-fluid" src="img/helix-blanco-logo-footer.png" alt="Logo Helix Intelligence Code">
                </a>
              </div>
...
const platillaNav = () => {
  ...
  return `<div class="navbar flex-nowrap fixed-top scrolling-navbar">
            ...
            <a class="navbar-brand" href="index">
              <img src="img/Helix-blanco.png" alt="Logo Helix Intelligence Code">
            </a>
